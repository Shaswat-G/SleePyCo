...
PRETRAIN_CONFIG_FILE=${1:-configs/SleePyCo-Transformer_SL-01_numScales-1_Sleep-EDF-2018_pretrain.json}
TRAIN_CONFIG_FILE=${2:-configs/SleePyCo-Transformer_SL-10_numScales-3_Sleep-EDF-2018_freezefinetune.json}
...
cd /cluster/home/shagupta/SleePyCo
